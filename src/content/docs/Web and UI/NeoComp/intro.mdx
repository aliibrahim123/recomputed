...
description: An Introduction about NeoComp
date: 2026-07-11
tags: [neocomp, web, js]
---
...
A new React can easily coexist with the old React, but the mental frameworks we developed over the past decade will have to be garbage-collected. This shift is theoretically viable, economically impossible, and youthfully ongoing.
