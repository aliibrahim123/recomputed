...
Ah... My last work before NeoView was [UniMap](../../projects#unimap), a pure pattern-matching language, and the last web-related one was [TEEP](../../projects#teep), a CPU implemented in TypeScript types.
